cask "vibooks" do
  ...
  on_arm do
    ...
    url "https://downloads.vibooks.ai/desktop/stable/1.0.3/darwin-aarch64/dmg/Vibooks_1.0.3_aarch64.dmg"
  end

  on_intel do
    sha256 "287fabd43262929a741df3664110c39a92e0a8c4b1487c0476344ce030769f49"
    url "https://downloads.vibooks.ai/desktop/stable/1.0.3/darwin-x86_64/dmg/Vibooks_1.0.3_x64.dmg"
  end
